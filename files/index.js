...
$(document).ready(function () {
  ...
  $.each(research, function (index, item) {
    ...
    $.each(item.researchData.data, function (index, item1) {
      // 为每个数组元素创建一个新的p标签
      var pTag = $('<p></p>').text(item1) // 设置p标签的文本内容为当前数组元素
