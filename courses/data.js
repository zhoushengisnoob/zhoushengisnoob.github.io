...
window.userData['gnn-2024'] = {
    ...
    sections: [{
    ...
    },
        {
            ...
            tableData: { // 删除该字段，则不显示表格
                heads: ['时间', '课程内容', '课程概述', '课程PPT'],
                rows: [['2024-11-5', '图神经网络简介', '课程介绍、认识图数据；介绍节点表征学习的方法，包括基于矩阵分解和基于随机游走', ''],
                    ['2024-11-12', '经典图神经网络', '介绍基于深度自编码器的节点表征学习、融合节点属性的节点表征学习、基于消息传递的节点表征学习', ''],
                    ['2024-11-19', '卷积图神经网络', '介绍卷积、傅里叶变换、图傅里叶变换和卷积图神经网络示例', ''],
                    ['2024-11-26', '富信息图神经网络', '介绍有向图、异构图和动态图的图神经网络技术', ''],
                    ['2024-12-3', '图结构学习神经网络', '介绍图结构学习神经网络、图结构生成网络', ''],
                    ['2024-12-10', '深度社区发现', '介绍图神经网络应用于社区发现任务的思路、案例', ''],
