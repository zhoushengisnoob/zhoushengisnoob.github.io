...
window.userData['data-mining-2024'] = {
    ...
    notifications: [
        {
            content: '2024-2025秋学期选课已经开始，欢迎大家选择本课程。',
            level: 'info'
        }
        // , {
        //     content: '课程通知内容',
    ...
    },
        {
            ...
            tableData: { // 删除该字段，则不显示表格
                ...
                ''
                    ...
                    ['2024-09-21', '数据分类技术', '介绍常见的数据分类技术和回归任务，包括决策树、线性回归、线性判别、集成学习',
                    ''
                ],
                    ['2024-09-24', '数据分类技术2', '介绍贝叶斯分类器，深入理解SVM，【New】深度分类模型，不平衡分类问题',
                    ''
                ],
                    ...
                    ['2024-11-29', '深度异常检测技术', '介绍常见的深度异常检测技术，如深度特征提取、基于特征提取的异常性判断、面向异常检测的特征学习、端到端异常检测模型等。', 
                    ''
                ]]
            }
        },
