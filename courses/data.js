    ...
    },
        {
            ...
            tableData: { // 删除该字段，则不显示表格
                ...
                ''
                    ...
                    ['2025-09-30', '数据分类技术2', '介绍贝叶斯分类器，深入理解SVM，【New】深度分类模型，不平衡分类问题',
                    ''
                ],
                    ['2025-10-07', '数据聚类技术', '介绍常见的聚类检测技术和指标，包括Kmeans改进版、谱聚类、层次聚类、高斯混合模型聚类、DBSCAN聚类等技术', 
                    ''
                ],
                    ['2025-10-14', '深度聚类技术', '介绍常见的深度聚类技术，如嵌入式聚类系列、对比聚类系列、伪标签系列等，以及基于聚类的表征学习和其他数据类型的聚类。',
                    ''
                ],
                    ['2025-10-21', '异常检测技术', '介绍常见的异常检测技术和部分深度异常检测技术',
                    ''
                ],
                    ['2025-10-28', '深度异常检测技术', '介绍常见的深度异常检测技术，如深度特征提取、基于特征提取的异常性判断、面向异常检测的特征学习、端到端异常检测模型等。',' ', 
                    ''
                ]]
            }
        },
