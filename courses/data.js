    ...
    },
        {
            ...
            tableData: { // 删除该字段，则不显示表格
                ...
                rows: [['2021-09-16', '数据挖掘与应用简介', '介绍课程的主要内容，形式，要求', ' <a href="./resources/DMCourse_01.pdf" target="_blank">DMCourse_01.pdf</a> '],
                    ...
                    ['2021-09-26', '数据分类技术', '介绍常见的数据分类技术，包括决策树，贝叶斯和深度神经网络分类器', ' <a href="./resources/DMCourse_2.pdf" target="_blank">DMCourse_2.pdf</a> '],
                    ['2021-09-30', '数据聚类技术', '介绍常见的数据聚类技术，包括K-means，高斯混合模型和深度聚类技术', ''],
