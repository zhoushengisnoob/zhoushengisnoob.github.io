...
window.userData['gnn-2025'] = {
    ...
    notifications: [
        {
            content: '[2025-11-01] 欢迎大家选择冬学期课程，时间是每周二下午。本学期课程将邀请多位企业专家进行授课与交流。',
            level: 'danger'
        }
    ...
    sections: [{
    ...
    },
        {
            ...
            tableData: { // 删除该字段，则不显示表格
                heads: ['时间', '课程内容', '课程概述', '课程PPT'],
                rows: [['2025-11-12', '图神经网络简介', '课程介绍、认识图数据；介绍节点表征学习的方法，包括基于矩阵分解和基于随机游走', ''],
                    ['2025-11-18', '经典图神经网络', '介绍基于深度自编码器的节点表征学习、融合节点属性的节点表征学习、基于消息传递的节点表征学习', ''],
                    ['2024-11-25', '卷积图神经网络', '介绍卷积、傅里叶变换、图傅里叶变换和卷积图神经网络示例', ''],
