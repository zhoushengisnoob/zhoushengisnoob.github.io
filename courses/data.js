window.userData = {
    ...
    notifications: [{
        content: '欢迎大家选择本课程，第一次课将在2021.09.17授课',
        level: 'info'
    }
    // , {
    //     content: '课程通知内容',
    ...
    },
        {
            ...
            tableData: { // 删除该字段，则不显示表格
                ...
                rows: [['2021-09-17', '数据挖掘与应用简介', '介绍课程的主要内容，形式，要求', ''],
                    ['2021-09-24', '数据预处理技术', '介绍数据采集与数据预处理技术，包括数据清洗，归约与变换', ''],
                    ['2021-10-08', '数据分类技术' , '介绍常见的数据分类技术，包括决策树，贝叶斯和深度神经网络分类器', ''],
                    ['2021-10-15', '数据聚类技术' , '介绍常见的数据聚类技术，包括K-means，高斯混合模型和深度聚类技术', ''],
                    ['2021-10-16', '异常检测技术' , '介绍常见的异常检测技术，包括离散样本，时序样本和时空样本的异常检测技术', ''],
                    ['2021-10-29', '图数据挖掘技术' , '介绍常见的图数据挖掘技术，包括图神经网络，节点分类，图分类等技术', ''],
                    ['2021-11-05', '数据挖掘的工业应用 ', '介绍数据挖掘在工业系统中的应用，包括推荐系统，检索系统和电子商务等', '']]
            }
        },
        {
            title: '常见问题',
